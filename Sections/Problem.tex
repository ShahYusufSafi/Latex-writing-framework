...
Canceling the geometric factors leads to the local relation
...
Physically, the dependence of conductivity on strain originates from changes in the underlying electronic structure and carrier transport properties, 
which are affected by lattice deformation.

The resulting model therefore introduces a nonlinear coupling between mechanical deformation and electrical conduction, 
linking continuum mechanics with electronic transport in a unified framework.
...
providing the basis for modeling the piezoresistive effect at the continuum level.